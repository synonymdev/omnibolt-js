...
class ObdApi {
    ...
    async createChannel(recipient_node_peer_id, recipient_user_peer_id, fundingAddressIndex = 0) {
        if (this.isNotString(recipient_node_peer_id)) {
            return result_1.err('error recipient_node_peer_id');
        }
        if (this.isNotString(recipient_user_peer_id)) {
        ...
        if (openChannelResponse.isErr()) {
            return result_1.err(openChannelResponse.error.message);
        }
        ...
        return result_1.ok(openChannelResponse.value);
    }
    async fundTempChannel(temporary_channel_id, fundingAddressIndex = 0, times_to_fund = 3, amount_to_fund = 0.00009, miner_fee = 0.000001) {
        ...
        for (let i = 0; i < times_to_fund; i++) {
            ...
            if (fundingRes.isErr()) {
                return result_1.err(fundingRes.error.message);
            }
        ...
        return result_1.ok('Successfully funded channel.');
    }
