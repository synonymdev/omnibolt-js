...
class ObdApi {
    constructor({ url = DEFAULT_URL } = {}) {
        ...
        this.loginPhrase = "";
        this.mnemonic = "";
        this.data = utils_1.defaultDataShape;
        this.saveData = (data) => null;
        this.updateCheckpoint = (data) => null;
        this.refreshChannel = () => null;
        this.listeners = {};
    ...
    async onChannelOpenAttempt(data) {
        ...
        try {
            ...
            this.data.signingData[temporary_channel_id] = types_1.channelSigningData;
    ...
    listener(key, method, data = "") {
        if (this?.listeners &&
            key in this.listeners &&
            method in this.listeners[key]) {
            this.listeners[key][method](data);
        }
        if (method === "failure")
