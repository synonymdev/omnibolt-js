...
class ObdApi {
    ...
    connect({ url = this.defaultUrl, onOpen = () => null, onMessage = () => null, onChannelOpenAttempt = (data) => null, onAcceptChannel = (data) => null, onBitcoinFundingCreated = (data) => null, onAssetFundingCreated = () => null, onChannelClose = () => null, onError = (e) => null, onClose = (code, reason) => null, onAddHTLC = () => null, onForwardR = () => null, onSignR = () => null, onCloseHTLC = () => null } = {}) {
