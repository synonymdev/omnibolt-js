...
class ObdApi {
    ...
    connect({ url = undefined, onOpen, onMessage, onChannelOpenAttempt, onChannelCloseAttempt, onAcceptChannel, onBitcoinFundingCreated, onAssetFundingCreated, onCommitmentTransactionCreated, on110353, on110352, onChannelClose, onError, onClose, onAddHTLC, onForwardR, onSignR, onCloseHTLC }) {
        return new Promise((resolve) => {
            ...
            if (on110353 !== undefined)
                this.on110353 = on110353;
            if (on110352 !== undefined)
                this.on110352 = on110352;
