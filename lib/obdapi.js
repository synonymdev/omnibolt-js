...
class ObdApi {
    ...
    async createChannel(recipient_node_peer_id, recipient_user_peer_id, fundingAddressIndex = 0, amount_to_fund = 0.00009, miner_fee = 0.000001, asset_id, asset_amount = 0) {
        if (this.isNotString(recipient_node_peer_id)) {
            return result_1.err('error recipient_node_peer_id');
        }
        if (this.isNotString(recipient_user_peer_id)) {
        ...
        return await this.fundTempChannel(temporary_channel_id, fundingAddressIndex, amount_to_fund, miner_fee, asset_id, asset_amount, recipient_node_peer_id, recipient_user_peer_id);
    }
    ...
    async fundTempChannel(temporary_channel_id, fundingAddressIndex = 0, amount_to_fund = 0.00009, miner_fee = 0.000001, asset_id = 137, asset_amount = 0, recipient_node_peer_id, recipient_user_peer_id) {
        const fundingAddress = await this.getFundingAddress({
            index: fundingAddressIndex,
        });
        if (fundingAddress.isErr()) {
