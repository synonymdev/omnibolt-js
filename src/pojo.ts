...
export class FundingBtcCreated {
  temporary_channel_id: string = "";
  funding_tx_hex: string = "";
}

export class FundingBtcSigned {
  temporary_channel_id: string = "";
  funding_txid: string = "";
...
export class OmniFundingAssetInfo {
  from_address: string = "";
  to_address: string = "";
...
export class OmniSendAssetInfo {
  from_address: string = "";
  to_address: string = "";
  property_id: number = 0;
  amount: number = 0;
...
export class AssetFundingCreatedInfo {
  temporary_channel_id: string = "";
  funding_tx_hex: string = "";
...
export class AssetFundingSignedInfo {
  temporary_channel_id: string = "";
  signed_alice_rsmc_hex: string = "";
}

export class SignedInfo101035 {
  temporary_channel_id: string = "";
...
export class SignedInfo101134 {
  channel_id: string = "";
  rd_signed_hex: string = "";
}

export class SignedInfo100360 {
  channel_id: string = "";
  rsmc_signed_hex: string = "";
  counterparty_signed_hex: string = "";
}

export class SignedInfo100361 {
  channel_id: string = "";
...
export class SignedInfo100364 {
  channel_id: string = "";
  c2b_rd_signed_hex: string = "";
}

export class SignedInfo100100 {
  channel_id: string = "";
...
export class CommitmentTxSigned {
  channel_id: string = "";
  msg_hash: string = "";
...
export class HTLCFindPathInfo extends InvoiceInfo {
  invoice: string = "";
  recipient_node_peer_id: string = "";
  recipient_user_peer_id: string = "";
...
export class ForwardRInfo {
  channel_id: string = "";
  r: string = "";
}

export class SignRInfo {
  channel_id: string = "";
...
export class CloseHtlcTxInfoSigned {
  msg_hash: string = "";
  last_rsmc_temp_address_private_key: string = "";
  last_htlc_temp_address_private_key: string = "";
  last_htlc_temp_address_for_htnx_private_key: string = "";
...
export class IssueManagedAmoutInfo {
  from_address: string = "";
  name: string = "";
  ecosystem: number = 0;
...
export class IssueFixedAmountInfo extends IssueManagedAmoutInfo {
  amount: number = 0;
}

export class OmniSendGrant {
  from_address: string = "";
  property_id: number = 0;
  amount: number = 0;
  memo: string = "";
...
export class OmniSendRevoke extends OmniSendGrant {}

export class CloseChannelSign {
  channel_id: string = "";
 ...
 * -81
 */
export class AtomicSwapAccepted extends AtomicSwapRequest {
